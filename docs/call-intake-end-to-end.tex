...
The optional compaction command keeps the newest 10,000 trace events, removes
only completed data covered by recovery snapshots, rotates the service log,
and keeps three log archives. It requires the deployment to be stopped.
