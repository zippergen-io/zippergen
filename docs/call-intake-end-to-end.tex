...
On this machine, deployment later uses the implementation record to detect a
specification change. If the project is transferred without private Studio
state, deployment warns that no record is available and proceeds after
