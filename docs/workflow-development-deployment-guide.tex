...
A project has exactly one deployment. Once initialized, its identity comes from
the project id alone, which is why none of these commands takes a name and why
moving the project preserves its deployment.
