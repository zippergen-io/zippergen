...
\texttt{zg inspect --deployment} & where each participant's local program is now \\
\texttt{zg inspect --deployment --watch} & keep that position open and refresh it in place \\
\texttt{zg trace --deployment} & recent protocol events \\
\texttt{zg tasks --deployment} & decisions waiting for a person \\
\texttt{zg approve --deployment} & answer one \\
