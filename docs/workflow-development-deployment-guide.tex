...
\texttt{zg deploy stop} / \texttt{restart} & move the service \\
\texttt{zg deploy compact} & reclaim space, the service must be stopped \\
...
\begin{enumerate}
  ...
  \item \texttt{zg deploy -{}-no-start}, then \texttt{zg deploy start}.
\end{enumerate}
