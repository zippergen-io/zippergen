...
travel with the project. If no key is available, the first command asks for
\texttt{OPENAI\_API\_KEY} without echo and saves it privately on this computer.
...
shows the available choices. It asks for the provider and model separately.
Full commands keep the compact \texttt{PROVIDER:MODEL} form and remain better
