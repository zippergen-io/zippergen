...
The first command creates that named configuration using the
\texttt{telegram} provider and says \emph{which} chat. The second says
\emph{who} is asked there: the \texttt{User}, whose \texttt{@human} action is
the approval.
