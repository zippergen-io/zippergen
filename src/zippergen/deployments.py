...
def deployment_artifacts(
    ...
    artifacts = [
        ...
        _artifact(
            ...
            _deployment_environment_releases_dir(name),
            "runtime/environment-generations",
            kind="directory",
        ),
        _artifact(
            "Private secret generations",
            _deployment_secrets_dir(name),
            "profile/secret-generations",
            kind="directory",
        ),
        _artifact(
            "Immutable bundles",
