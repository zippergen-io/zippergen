...
:root {
  ...
  --col-op-fill:    #d8e0fb;
  --col-op-bdr:     #9aa9ec;
  --col-send-fill:  #f0f2f5;
  --col-send-bdr:   #c8cdd4;
  --col-recv-fill:  #f0f2f5;
  --col-recv-bdr:   #c8cdd4;
  --col-sel:        #1d4ed8;
  --rule:         #e0e4e8;
  --rule-hdr:     #e0e4e8;
...
.col-act-human { background: var(--accent-attn-bg); border-color: #f0b0a4; border-width: 1px; }
.col-act-human.col-pending { border-color: var(--accent-attn); }
...
#detail-body { flex: 1; overflow-y: scroll; -webkit-overflow-scrolling: touch; padding: 32px 56px; }
...
@media (max-height: 500px) {
  #detail-topbar { padding-top: 6px; padding-bottom: 6px; }
  #detail-body   { padding-top: 14px; padding-bottom: 14px; }
  .ins-meta      { margin-bottom: 6px; }
  .ins-await-row { margin-bottom: 4px; }
  .ins-title     { font-size: 18px; margin-bottom: 12px; }
  .ins-section   { margin-bottom: 12px; }
  .ins-actions   { margin-top: 12px; }
  .ea            { padding: 12px 18px; }
}
</style>
</head>
<body>
...
function colSetScrollH(ll, h){
  ...
  if(pinned) colView.scrollTop = colView.scrollHeight;
}
